...
struct qt_meta_stringdata_OpenSourceThread_t {
    QByteArrayData data[3];
    char stringdata0[25];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_OpenSourceThread_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_OpenSourceThread_t qt_meta_stringdata_OpenSourceThread = {
    {
QT_MOC_LITERAL(0, 0, 16), // "OpenSourceThread"
QT_MOC_LITERAL(1, 17, 6), // "isDone"
QT_MOC_LITERAL(2, 24, 0) // ""

    },
    "OpenSourceThread\0isDone\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_OpenSourceThread[] = {
...
void OpenSourceThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<OpenSourceThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (OpenSourceThread::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OpenSourceThread::isDone)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject OpenSourceThread::staticMetaObject = { {
    &QThread::staticMetaObject,
    qt_meta_stringdata_OpenSourceThread.data,
    qt_meta_data_OpenSourceThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *OpenSourceThread::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *OpenSourceThread::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_OpenSourceThread.stringdata0))
        return static_cast<void*>(this);
    return QThread::qt_metacast(_clname);
}

int OpenSourceThread::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
